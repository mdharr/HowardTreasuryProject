...
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (29, 'The Song of a Mad Minstrel', NULL, 'I am the thorn in the foot, I am the blur in the sight; I am the worm at the root, I am the thief in the night. I am the rat in the wall, the leper that leers at the gate; I am the ghost in the hall, herald of horror and hate. I am the rust on the corn, I am the smut on the wheat, Laughing man\'s labor to scorn, weaving a web for his feet. I am canker and mildew and blight, danger and death and decay; The rot of the rain by night, the blast of the sun by day.');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (30, 'The Symbol', NULL, 'Eons before Atlantean days in the time of the world\'s black dawn, Strange were the kings and grim the deeds that the pallid moon looked on. When the great black cities split the stars and strange prows broke the tide, And smoke went up from ghastly shrines where writhing victims died. Black magic raised its serpent head, and all things foul and banned, Till an angry God hurled up the sea against the shuddering land. And the grisly kings they read their doom in the wind and the rising brine, And they set a pillar on a hill for a symbol and a sign.');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (31, 'The Tavern', NULL, 'There stands, close by a dim, wolf-haunted wood, A tavern like a monster, brooding thing. About its sullen gables no birds sing. Of a lone traveller, when the moon is blood, Lights from his horse in quest of sleep and meal. His footfalls fade within and sound no more; He comes not forth; but from a secret door Bearing a grisly burden, shadows steal.');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (32, 'To a Woman', NULL, 'Though fathoms deep you sink me in the mould, Locked in with thick-lapped lead and bolted wood, Yet rest not easy in your lover\'s arms; Let him beware to stand where I have stood. I shall not fail to burst my ebon case, And thrust aside the clods with fingers red: Your blood shall turn to ice to see my face Look from the shadows on your midnight bed.');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (33, 'Up, John Kane!', NULL, 'Up, John Kane, the grey night\'s falling; The sun\'s sunk in blood and the fog comes crawling; From hillside to hill the grey wolves are calling; Will ye come, will ye come, John Kane? What of the oath that you swore by the river Where the black shadows lurk and the sun comes never, And a Shape in the shadows wags its grisly head forever?');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (34, 'Which Will Scarcely Be Understood', NULL, 'Small poets sing of little, foolish things, As more befitting to a shallow brain That dreams not of pre-Atlantean kings, Nor launches on that dark uncharted Main That holds grim islands and unholy tides, Where many a black mysterious secret hides. True rime concerns her not with bursting buds, The chirping bird, the lifting of the rose —— Save ebon blooms that swell in ghastly woods, And that grim, voiceless bird that ever broods Where through black boughs a wind of horror blows.');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (35, 'A Word From the Outer Dark', NULL, 'My ruthless hands still clutch at life — Still like a shorless sea My soul beats on in rage and strife. You may not shackle me. My leopard eyes are still untamed, They hold a darksome light — A fierce and brooding gleam unnamed That pierced primeval night. Rear mighty temples to your god — I lurk where shadows sway, Till, when your drowsy guards shall nod To leap and rend and slay. For I would hurl your cities down And I would break your shrines And give the site of every town To thistles and to vines. Higher the walls of Nineveh And prouder Babel\'s spires — I bellowed from the desert way — They crumbled in my fires.');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (36, 'An Echo From the Iron Harp', NULL, 'Shadows and echoes haunt my dreams with dim and subtle pain, With the faded fire of a lost desire, like a ghost on a moonlit plain. In the pallid mist of death-like sleep she comes again to me: I see the gleam of her golden hair and her eyes like the deep grey sea. We came from the North as the spume is blown when the blue tide billows down; The kings of the South were overthrown in ruin of camp and town.');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (37, 'The Dust Dance (version II)', NULL, 'The sin and jest of the times am I Since destiny\'s dance began, When the weary gods from the dews and sods Made me and named me man. Ah, it\'s little they knew when they molded me For a pawn of their cosmic chess, What a mummer wild, what an insane child They fashioned from nothingness!');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (38, 'The Ghost Kings', NULL, 'The ghost kings are marching; the midnight knows their tread, From the distant, stealthy planets of the dim, unstable dead; There are whisperings on the night-winds and the shuddering stars have fled. A ghostly trumpet echoes from a barren mountainhead; Through the fen the wandering witch-lights gleam like phantom arrows sped; There is silence in the valleys and the moon is rising red.');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (39, 'Lines Written in the Realization That I Must Die', NULL, 'The Black Door gapes and the Black Wall rises; Twilight gasps in the grip of Night. Paper and dust are the gems man prizes — Torches toss in my waning sight. Drums of glory are lost in the ages, Bare feet fail on broken trail — Let my name fade from the printed pages; Dreams and visions are growing pale.');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (40, 'The Marching Song of Connacht', NULL, 'The men of the East are decked in steel, They march with a trumpet\'s din, They glitter with silks and golden scales, And high kings boast their kin — We of the West wear the hides of wolves, But our hearts are steel within. They of the East ride gallant steeds, Their spears are long and brown; Their shields are set with sparkling stones, And each knight wears a crown — We fight on foot as our forebears fought, And we drag the rider down.');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (41, 'Recompense', NULL, 'I have not heard lutes beckon me, nor the brazen bugles call, But once in the dim of a haunted lea I heard the silence fall. I have not heard the regal drum, nor seen the flags unfurled, But I have watched the dragons come, fire-eyed, across the world. I have not seen the horsemen fall before the hurtling host, But I have paced a silent hall where each step waked a ghost.');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (42, 'The Song of the Last Briton', NULL, 'The sea is grey in the death of day, Behind me lifts the night. I\'ll flee no more from the ancient shore Where first I saw the light. The Saxons come and the Saxons go With the ebb and flow of the tide; Their galleys loom, grim shapes of doom, But here shall I abide. My castles rust in crimson dust, Red ruin tossed in the drift — But the sea is grey, and the wolf\'s at bay, And the ravens circle swift.');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (43, 'The Tide', NULL, 'Thus in my mood I love you In the drum of my heart\'s fast beat, In the lure of the skies above you And the earth beneath your feet. Now I can lift and crown you With the moon\'s white empery, Now I can crush and drown you In my passion\'s misty sea.');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (44, 'Untitled (\"You have built a world of paper and wood...\")', NULL, 'You have built a world of paper and wood, Culture and cult and lies; Has the cobra altered beneath his hood, Or the fire in the tiger\'s eyes? You have turned from valley and hill and flood, You have set yourselves apart, Forgetting the earth that feeds the blood And the talon that finds the heart.');
INSERT INTO `poem` (`id`, `title`, `text_url`, `excerpt`) VALUES (45, 'A Song of the Naked Lands', NULL, 'You lolled in gardens where breezes fanned The blossom\'s shivering shard; But we were bred in a naked land Where life was bitter and hard. You raped the grapes of their purple soul for your wine cups brimming high; We stooped to the dregs of the muddy hole That was bitter with alkali. And you grew flabby and round of limb, Short of nerve and breath; But we grew rugged and lean and grim In our naked grip with Death.');
...
INSERT INTO `miscellanea` (`id`, `title`, `text_url`, `excerpt`) VALUES (2, 'Untitled draft (\"\'Thus,\' said Tu...\")', NULL, 'Thus,\" said Tu, chief councillor, \"did Lala-ah, countess of Fanara, flee with her lover, Felgar, Farsunian adventurer, bringing shame to her hustband-to-be and to the nation of Valusia.\" Kull, fist supporting chin, nodded. He had listened with scant interest to the tale of how the young countess of Fanara had left a Valusian nobleman waiting on the steps of Merama\'s and had eloped with a man of her own choice.');
INSERT INTO `miscellanea` (`id`, `title`, `text_url`, `excerpt`) VALUES (3, 'Untitled fragment (\"A land of wild, fantastic beauty...\")', NULL, 'A land of wild, fantastic beauty; of mighty trees and great rivers, of tangled, breathless jungle and boundless, unlimited prairies, of towering, awesome crags, and dank, gloomy, fever-ridden swamps, of reeking, far stretching savannas, and of great lakes. A land of pleasant summer and cruel, merciless winter. A land of beauty and terror. A land of wild beasts and wilder men. Mighty beasts roamed the mountains and the plains and jungle. Through the nights walked Na-go-sa-na, the tawny one, the Fear That Walks By Night, and Sa-go-na, the cruel sabertooth. Often upon the plains and among the brakes of the savannas, might be seen the gigantic form of Ga-so-go, the mammoth, the Hill That Walks.');
INSERT INTO `miscellanea` (`id`, `title`, `text_url`, `excerpt`) VALUES (4, 'Untitled fragment (\"So I set out up the hill-trail...\")', NULL, 'determined. So I set out up the hill-trail as if on a hunt and was pleased to note that she was following me. When I came to a rather wild, craggy place among the hill, I walked around a great boulder and then turned back on the trail and waited, with a certain glee. Ah-lala came face to face with me before she knew I was about. I caught her by the wrists and dragged her along the trail for some distance before she came to herself, so astonished she was, and then she fought like a little demon.');
INSERT INTO `miscellanea` (`id`, `title`, `text_url`, `excerpt`) VALUES (5, 'Untitled fragment (\"Three men sat...\")', NULL, 'Three men sat at a table playing a game. Across the sill of an open window there whispered a faint breezing, blowing the filmy curtains about and bearing to the players the incense of roses and vines and growing green things. Three men sat at a table — one was a king — one a prince of an ancient house — one was the chief of a terrible and barbaric nation. \"Score!\" quoth Kull, king of Valusia, as he moved one of the ivory figures. \"My wizard menaces your warrior, Brule.\"');
...
START TRANSACTION;
USE `howardtreasurydb`;
INSERT INTO `illustrator` (`id`, `name`, `image_url`, `description`) VALUES (1, 'Mark Schultz', 'https://www.sdcomicfest.org/images/mark-schultz-by-mark-thelosen.jpg', 'Mark Schultz (born June 7, 1955) is an American writer and illustrator of books and comics. Schultz’s first published comics work was on a story called “The Sea King”, featuring Robert E. Howard’s character King Kull, which appeared in Savage Sword of Conan #132, published by Marvel Comics. In 2002, Schultz contributed a number of illustrations to Conan the Cimmerian: Volume 1, a new reprinting of the Conan stories of Robert E. Howard, published by Wandering Star Books. The book has since been reprinted in paperback by Del Rey as The Coming of Conan the Cimmerian.');
INSERT INTO `illustrator` (`id`, `name`, `image_url`, `description`) VALUES (2, 'Gary Gianni', 'https://pbs.twimg.com/profile_images/713054373098729472/hg0GYX03_400x400.jpg', 'Gary Gianni (born 1954) is an American comics artist best known for his eight years illustrating the syndicated newspaper comic Prince Valiant. Gianni provided the cover and interior art for the second of Wandering Star\'s Conan collections, Conan of Cimmeria: Volume Two (1934) (2004), also published by Del Rey as The Bloody Crown of Conan (2003, 2005). (He also illustrated two of Wandering Star\'s other definitive Robert E. Howard collections, The Savage Tales of Solomon Kane (1998) and Bran Mak Morn: The Last King, both also published by Del Rey.)');
INSERT INTO `illustrator` (`id`, `name`, `image_url`, `description`) VALUES (3, 'Justin Sweet', 'https://cdnb.artstation.com/p/users/avatars/000/146/925/large/9ff35502b63c2d448361060b64e6f2c7.jpg', 'A concept artist, illustrator and gallery artist. He also works for various game and book publishers, including production companies. He is a well known and respected fantasy artist and some of his clients include Disney, National Geographic, Wizards of the Coast, Tor, DelRey, and Wandering Star. Justin also did concept work for Magic: The Gathering, Avengers, Guardians of the Universe, John Carter, Prince Caspian, and Game of Thrones.');
INSERT INTO `illustrator` (`id`, `name`, `image_url`, `description`) VALUES (4, 'Jim Keegan', 'https://images.squarespace-cdn.com/content/v1/6232a326973c4550cddc63e0/39164cd0-9f1c-41fc-99ea-65e8f57d7a67/IMG_5879.jpeg', 'Jim & Ruth Keegan are award-winning collaborative artists who have illustrated books by Stephen King, Robert E. Howard, Fritz Leiber, William F. Nolan, George Clayton Johnson, and many others. Their clients include Penguin Random House, Bantam Books, Del Rey Books, Dark Horse Comics, Columbia Tri-Star, The CW Network, Carsey-Warner, Playboy Enterprises, Centipede Press, The Robert. E. Howard Foundation, Wandering Star Books, and Montgomery Studios.');
INSERT INTO `illustrator` (`id`, `name`, `image_url`, `description`) VALUES (5, 'Ruth Keegan', 'https://reh.world/wp-content/uploads/2021/09/jimruth2_web.png', 'Jim & Ruth Keegan are award-winning collaborative artists who have illustrated books by Stephen King, Robert E. Howard, Fritz Leiber, William F. Nolan, George Clayton Johnson, and many others. Their clients include Penguin Random House, Bantam Books, Del Rey Books, Dark Horse Comics, Columbia Tri-Star, The CW Network, Carsey-Warner, Playboy Enterprises, Centipede Press, The Robert. E. Howard Foundation, Wandering Star Books, and Montgomery Studios.');
INSERT INTO `illustrator` (`id`, `name`, `image_url`, `description`) VALUES (6, 'Gregory Manchess', 'https://www.24-7pressrelease.com/assets/attachments/048/press_release_distribution_0487109_175641.jpg', 'The award-winning painter Gregory Manchess has worked as a freelance illustrator for nearly forty years. His work appeared in Conan of Cimmeria: Volume Three (1935-1936), a collection of Robert E. Howard\'s Conan stories, published by Wandering Star, and published by Del Rey as The Conquering Sword of Conan.');
...
START TRANSACTION;
USE `howardtreasurydb`;
INSERT INTO `blog_post` (`id`, `title`, `content`, `created_at`, `user_id`, `hidden`, `image_url`) VALUES (1, 'My Favorite Solomon Kane Tale: “Wings in the Night” by Robert E. Howard', '<p>&ldquo;Wings in the Night&rdquo; (1932), is one of Solomon Kane&rsquo;s, Robert E. Howard&rsquo;s swashbuckling Purita<span style=\"font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Oxygen, Ubuntu, Cantarell, \'Open Sans\', \'Helvetica Neue\', sans-serif;\">n, African adventures. In the face of darkness, he sees himself as Satan&rsquo;s implacable foe.&nbsp; Kane&rsquo;s a dour man, dedicated wholly to defeating evil and meting out justice. In two separate stories, he spends years hunting for the killers of innocents. A skilled swordsman, he has freeboote</span><img class=\"wp-image-50339\" style=\"font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Oxygen, Ubuntu, Cantarell, \'Open Sans\', \'Helvetica Neue\', sans-serif; float: right;\" src=\"https://goodman-games.com/wp-content/uploads/2022/01/1-WingsInTheNight-1.gif\" alt=\"\" width=\"195\" height=\"185\"><span style=\"font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Oxygen, Ubuntu, Cantarell, \'Open Sans\', \'Helvetica Neue\', sans-serif;\">d in the New World, suffered at the hand of the Inquisition, and fought vampires and cannibals in Afric</span><span style=\"font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Oxygen, Ubuntu, Cantarell, \'Open Sans\', \'Helvetica Neue\', sans-serif;\">a. In this stor</span><span style=\"font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Oxygen, Ubuntu, Cantarell, \'Open Sans\', \'Helvetica Neue\', sans-serif;\">y, he b</span><span style=\"font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Oxygen, Ubuntu, Cantarell, \'Open Sans\', \'Helvetica Neue\', sans-serif;\">attles</span><span style=\"font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Oxygen, Ubuntu, Cantarell, \'Open Sans\', \'Helvetica Neue\', sans-serif;\">great bat-winged, razor-tal</span><span style=\"font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Oxygen, Ubuntu, Cantarell, \'Open Sans\', \'Helvetica Neue\', sans-serif;\">oned monsters.</span></p>\n<div class=\"wp-block-image\">&nbsp;</div>\n<p>This story is one of REH&rsquo;s most visceral, and blood is spilled on every other page. Also, it&rsquo;s one of my favorites. As it opens, Kane is fleeing from a band of cannibals when he discovers a devastated village and within it, a mutilated, yet still living man, tied to a stake. The village appears to have been attacked from above. One body hangs high up in a tree, impaled upon a branch. Continuing to evade his pursuers, he finds himself set upon by a winged creature with a manlike face.&nbsp;</p>\n<p>He barely survives that encounter, thanks only to the ministrations of people from the village of Upper Bogonda. That town has long been subject to the bloody depredations of a tribe of winged monsters. Seeing that Kane killed one of the creatures, they look to him for protection. Denying any of the divine power they perceive in him, as well as any real hope he can defend them, he pledges to stay with them nonetheless: &ldquo;Yet will I stay here in Bogonda all the rest of my life if ye think I be protection to the people.&rdquo; It&rsquo;s an effort that ends in failure and madness.&nbsp;</p>\n<p>&ldquo;Wings&rdquo; is bloody and savage, more so than any other of Howard&rsquo;s stories that come to mind. It shares with the Conan story, &ldquo;Beyond the Black River,&rdquo; a sense of inevitable doom, but it&rsquo;s far darker. That story revolves around colonists facing off against the indigenous tribes; here, villagers forlornly await their fates at the claws of sadistic creatures who view them as little more than cattle. Hundreds of innocents are torn apart, decapitated, or eaten alive. In the end, they all end up in the monsters&rsquo; bellies and Kane is a screaming madman. Kane may avenge the Bogondans, it does them no good and he&rsquo;s still mad.&nbsp;</p>\n<div class=\"wp-block-image\"><a href=\"https://goodman-games.com/wp-content/uploads/2022/01/2-wings-III-0001.jpg\"><img class=\"wp-image-50340\" style=\"float: right;\" src=\"https://goodman-games.com/wp-content/uploads/2022/01/2-wings-III-0001-685x1024.jpg\" sizes=\"(max-width: 225px) 100vw, 225px\" srcset=\"https://goodman-games.com/wp-content/uploads/2022/01/2-wings-III-0001-685x1024.jpg 685w, https://goodman-games.com/wp-content/uploads/2022/01/2-wings-III-0001-201x300.jpg 201w, https://goodman-games.com/wp-content/uploads/2022/01/2-wings-III-0001-768x1148.jpg 768w, https://goodman-games.com/wp-content/uploads/2022/01/2-wings-III-0001-600x897.jpg 600w, https://goodman-games.com/wp-content/uploads/2022/01/2-wings-III-0001.jpg 1011w\" alt=\"\" width=\"225\" height=\"335\" loading=\"lazy\"></a></div>\n<p><em>He threw back his head to shriek his hate at the fiends above him and he felt warm, thick drops fall into his face, while the shadowy skies were filled with the screams of agony and the laughter of monsters. And Kane&rsquo;s last vestige of reason snapped as the sounds of that ghastly feast in the skies filled the night and the blood that rained from the stars fell into his face. He gibbered to and fro, screaming chaotic blasphemies.</em></p>\n<p><em>And was he not a symbol of Man, staggering among the tooth-marked bones and severed grinning heads of humans, brandishing a futile ax, and screaming incoherent hate at the grisly, winged shapes of Night that make him their prey, chuckling in demoniac triumph above him and dripping into his mad eyes the pitiful blood of their human victims?</em></p>\n<p>The story is a gripping, propulsive read that shows Howard&rsquo;s writing at its best. Before hitting the reader with monsteriffic action, he pulls you in with mystery and horror; who destroyed the village and why was the man bound to the post? At the same time, there&rsquo;s the implicit fear of the pursuing cannibals. From the first paragraphs, Howard starts building tension and keeps ratcheting it up until it has to explode. When the action comes, it&rsquo;s swift and sharp:</p>\n<p><em>The winged man had wrapped his limbs about the Englishman&rsquo;s legs and the talons he had driven into Kane&rsquo;s breast muscles held like fanged vices. The wolf-like fangs drove at Kane&rsquo;s throat, but the Puritan gripped the bony throat and thrust back the grisly head, while with his right hand he strove to draw his dirk. The birdman was mounting slowly and a fleeting glance showed Kane that they were already high above the trees. The Englishman did not hope to survive this battle in the sky, for even if he slew his foe, he would be dashed to death in the fall. But with the innate ferocity of the fighting man he set himself grimly to take his captor with him.</em></p>\n<div class=\"wp-block-image\"><img class=\"wp-image-50341\" style=\"float: right;\" src=\"https://goodman-games.com/wp-content/uploads/2022/01/3-Wings_in_the_Night.04.jpg\" sizes=\"(max-width: 225px) 100vw, 225px\" srcset=\"https://goodman-games.com/wp-content/uploads/2022/01/3-Wings_in_the_Night.04.jpg 377w, https://goodman-games.com/wp-content/uploads/2022/01/3-Wings_in_the_Night.04-225x300.jpg 225w\" alt=\"\" width=\"225\" height=\"301\" loading=\"lazy\"></div>\n<p>&ldquo;Wings in the Night&rdquo; also displays Howard&rsquo;s ease at world- and myth-building. The Bogondan priest, Goru, tells Kane the tragic tale of how his people came to be the flying monsters and the cannibals. At the same time, his story triggers in Kane an idea that the monsters might have links to even older stories reaching back to older legends from beyond the African shores. We also learn some of Kane&rsquo;s bloody past. The story doesn&rsquo;t exist in a vacuum, but, instead, reads like a chapter from some longer work, set in a larger world of shadows and dangers that stretch far beyond the boundaries of its fifty pages. (Which, of course, is true &ndash; REH published five other Kane stories in his lifetime)</p>\n<p>My first encounter with Solomon Kane wasn&rsquo;t with one of the actual stories but in a comic book version. I picked up a small stack of&nbsp;<strong>The Savage Sword of Conan</strong>&nbsp;at a street fair. The Conan stories didn&rsquo;t do much for me &ndash; I&rsquo;m just not a fan of fur-loinclothed Conan &ndash; but in the back of issues 53 and 54 was something that grabbed me: writer Don Glut and artist David Wenzel&rsquo;s adaptation of &ldquo;Wings in the Night.&rdquo; It was gruesome and violent, and that was enough for me.&nbsp;</p>\n<p>It was only when I picked up copies of the Bantam Solomon Kane collections,&nbsp;<strong>The Hills of the Dead</strong>, did I read Howard&rsquo;s own words. If the comic had impressed me, the real story gutted me. And it still does. Along with blood and thunder, the story has a brutal emotional core. If, somehow, you have missed out on Solomon Kane&rsquo;s adventures, get thee hence at once to a book-selling establishment.&nbsp;</p>', '2023-10-28T12:35:22', 1, 0, 'https://goodman-games.com/wp-content/uploads/2022/01/WebsiteGraphic_WIDE_012822_1.jpg');
