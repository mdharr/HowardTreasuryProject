...
INSERT INTO `person` (`id`, `name`, `image_url`, `description`) VALUES (13, 'Kull', 'https://pbs.twimg.com/media/DwXi0mbVsAAXD7H.jpg', 'n the mists of prehistory, the warrior Kull won a throne by his mighty sword and his more deadly battle axe. He has won a kingdom, but now must hold it against the plotting of treacherous nobles and the evil serpent-men who can change their forms to appear human. But Kull will prevail against all challenges, shouting his cry above the din of battle, \"By this axe I rule!\"');
