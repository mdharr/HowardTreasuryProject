...
INSERT INTO `story` (`id`, `title`, `text_url`, `first_published`, `alternate_title`, `is_copyrighted`, `copyright_expires_at`, `excerpt`, `description`) VALUES (46, 'Red Nails', 'http://gutenberg.net.au/ebooks06/0600771h.html', NULL, NULL, NULL, NULL, 'THE woman on the horse reined in her weary steed. It stood with its legs wide-braced, its head drooping, as if it found even the weight of the gold-tassled, red-leather bridle too heavy. The woman drew a booted foot out of the silver stirrup and swung down from the gilt-worked saddle. She made the reins fast to the fork of a sapling, and turned about, hands on her hips, to survey her surroundings. They were not inviting. Giant trees hemmed in the small pool where her horse had just drunk. Clumps of undergrowth limited the vision that quested under the somber twilight of the lofty arches formed by intertwining branches. The woman shivered with a twitch of her magnificent shoulders, and then cursed.', NULL);
INSERT INTO `story` (`id`, `title`, `text_url`, `first_published`, `alternate_title`, `is_copyrighted`, `copyright_expires_at`, `excerpt`, `description`) VALUES (47, 'The Servants of Bit-Yakin', 'http://gutenberg.net.au/ebooks06/0600761h.html', NULL, NULL, NULL, NULL, 'The cliffs rose sheer from the jungle, towering ramparts of stone that glinted jade blue and dull crimson in the rising sun, and curved away and away to east and west above the waving emerald ocean of fronds and leaves. It looked insurmountable, that giant palisade with its sheer curtains of solid rock in which bits of quartz winked dazzlingly in the sunlight. But the man who was working his tedious way upward was already half way to the top. He came of a race of hillmen, accustomed to scaling forbidding crags, and he was a man of unusual strength and agility. His only garment was a pair of short red silk breeks, and his sandals were slung to his back, out of his way, as were his sword and dagger.', NULL);
